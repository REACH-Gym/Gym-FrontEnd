...
import NewRequestItem from "../NewRequestItem/NewRequestItem";
...
function NewRequests() {
  ...
  const handleExcelSheet = () => {
    exportToExcel(data?.data?.users, "New_Requests");
  };
      ...
      <div className={`${styles.scheduleContainer}`}>
        <div className="d-flex align-items-center justify-content-between gap-3 ps-3 pe-3">
          <ComponentTitle
            ...
            subTitle={"يمكنك متابعة جميع الطلبات الجديدة  من هنا"}
          />
          <Filter
            filter={true}
          ...
          <div className={`${styles.tableContainer} text-end mt-3 ps-4 pe-4`}>
            <table className="w-100">
              <thead className={`fw-bold`}>
                ...
                <th className={`p-2 pt-3 pb-3`}>رقم الهاتف</th>
